...
| -------------------------------------------------------------------*/
	...
	/*if(strpos($_SESSION['img_path'],'/images/temp')){
		$s_id=session_id();
		$new_dir=$_SESSION['upload_path'].'/'.$s_id;
		if(!file_exists($new_dir)){
			mkdir($new_dir, 0755, true);
		}		
		$config['img_path'] = $_SESSION['img_path'].'/'.$s_id;
		$config['upload_path'] = $_SESSION['upload_path'].'/'.$s_id;
	} else{
		$config['img_path'] = $_SESSION['img_path'];
		$config['upload_path'] = $_SESSION['upload_path'];
	}*/
	
	$config['img_path'] = '/images/questions';
	$config['upload_path'] = $_SERVER['DOCUMENT_ROOT'].'/images/questions';
/*-------------------------------------------------------------------
| 
